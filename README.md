...
调用example（下图1间接调用，2直接调用了）：
     <img width="735" alt="image" src="https://github.com/user-attachments/assets/0bd6997a-74e3-4c53-b079-8d10f5a91b2e">
      图1
     <img width="735" alt="image" src="https://github.com/user-attachments/assets/b6f77037-1cc6-4414-abc3-ed86cd91b32d">
      图2


2. 修改 comfyUI 的配置（主要关注 configs/node_fields.py 中的 PULID_FLUX_MAPPINGS 和 NODE_FILE_FIELDS 两处修改即可）
      <img width="735" alt="image" src="https://github.com/user-attachments/assets/71ee6ced-0f64-47fd-8a9b-04b4e9d86044">
      <img width="735" alt="image" src="https://github.com/user-attachments/assets/ab03c303-a841-4932-9c92-886d0b287b68">
